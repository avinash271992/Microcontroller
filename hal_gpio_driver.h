...
/* MCU specific header file stm32f407vgt6 based discovery board */
#include "stm32f407xx.h"

/******************************************************************************/
/*               1. MACRO used for GPIO PIN initialization 
*/
/******************************************************************************/
...
/* GPIO pull up/down selection value */
...
/* MACROS to enable clocks for different GPIO ports in RCC register */
#define _HAL_RCC_GPIOA_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 0 ) )
#define _HAL_RCC_GPIOB_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 1 ) )
#define _HAL_RCC_GPIOC_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 2 ) )
#define _HAL_RCC_GPIOD_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 3 ) )
#define _HAL_RCC_GPIOE_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 4 ) )
#define _HAL_RCC_GPIOF_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 5 ) )
#define _HAL_RCC_GPIOG_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 6 ) )
#define _HAL_RCC_GPIOH_CLOCK_ENABLE()          (RCC->AHB1ENR |= (1 << 7 ) )
